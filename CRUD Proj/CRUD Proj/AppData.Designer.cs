...
namespace CRUD_Proj {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Full_Name, string PhoneNumber, string Email, string Address, byte[] Image) {
...
namespace CRUD_Proj.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Full Name` IS NULL) OR (`Full Name` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`Full Name`, `PhoneNumber`, `Email`, `Address`, `Image`)" +
                " VALUES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `Full Name` = ?, `PhoneNumber` = ?, `Email` = ?, `Address` = ?, `Image` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Full Name` IS NULL) OR (`Full Name` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\\dadb.accdb";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, [Full Name], PhoneNumber, Email, Address, [Image] FROM Employe" +
                "es";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Full_Name, string Original_PhoneNumber, string Original_Email, string Original_Address) {
        ...
        public virtual int Insert(string Full_Name, string PhoneNumber, string Email, string Address, byte[] Image) {
            if ((Full_Name == null)) {
        ...
        public virtual int Update(string Full_Name, string PhoneNumber, string Email, string Address, byte[] Image, int Original_EmployeeID, string Original_Full_Name, string Original_PhoneNumber, string Original_Email, string Original_Address) {
            if ((Full_Name == null)) {
